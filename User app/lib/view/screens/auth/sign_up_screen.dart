...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void initState() {
    super.initState();
    _emailController.text = getRandomString(9) + '@gmail.com';
  ...
  void _register(AuthController authController, String countryCode) async {
    ...
    // }
      ...
      authController.registration(signUpBody).then((status) async {
        ...
        } else if (status.message == 'The email has already been taken.') {
          showCustomSnackBar('This phone number is already registered');
